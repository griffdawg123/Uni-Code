// Example tests for Assignment 1
...
- These tests are by no means comprehensive - you should do your own
  testing by making a copy of this file, adding your own tests to it,
  running that test file, and inspecting the output.
...
static void usage(char *progName) {
    printf("Usage: %s <test number (1-5)>\n", progName);
}
