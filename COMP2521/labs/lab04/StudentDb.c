...
int compareByName(Record r1, Record r2) {
    // compare name and return if -1 or 1
...
List DbFindByName(StudentDb db, char *familyName, char *givenName) {
    Record dummyLower = RecordNew(1, familyName, givenName);
    Record dummyUpper = RecordNew(9999999, familyName, givenName);
